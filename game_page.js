...
document.getElementById("player1Score").innerHTML = player1Name + " : ";
document.getElementById("player2Score").innerHTML = player2Name + " : ";
...
function send() {
    ...
    charArt1 = word.charAt(1);
    console.log(charAt1);

    lenghtDivide2 = Math.floor(word.length/2);
    harAt2 = word.charAt(lenghtDivide2);
	console.log(charAt2);
...
function check()
{
    getAnswer = document.getElementById("inputCjeckBox").value;
